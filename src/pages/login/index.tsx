...
import HexagonDiagram from "./components/animationLogin";
    ...
    <>
      ...
      <Box
        sx={{
          ...
          alignItems: "center",
          minHeight: "100vh",
          bgcolor: "transparent", // Changed from "background.default" to transparent
          borderRadius: "12px",
        }}
      >
        <Paper
          ...
          sx={{
            ...
            width: "90%",
            borderRadius: 2,
            // Add slight transparency to show background animation
